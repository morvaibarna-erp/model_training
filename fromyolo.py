...
class Yolov8TFLite:
    ...
    def __init__(self, tflite_model, input_image, confidence_thres, iou_thres):
        ...
        self.classes = yaml_load(check_yaml("yolo_annotate/model/two_label_v3_saved_model/data.yaml"))["names"]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model", type=str, default="yolo_annotate/model/two_label_v3_saved_model/two_label_v3_full_integer_quant.tflite", help="Input your TFLite model."
    )
    parser.add_argument("--img", type=str, default=str("yolo_annotate/megfelelt/ALTMP_ICP_13.JPG"), help="Path to input image.")
